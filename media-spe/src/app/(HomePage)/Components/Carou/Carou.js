      ...
      <div className={viewMore ? style.viewMoreOpen : style.viewMoreClose}>
        <button onClick={openViewMore}>
          <svg xmlns="http://www.w3.org/2000/svg" width="25" height="14" viewBox="0 0 25 14" fill="none">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.375644 0.465774C0.900283 -0.127999 1.77923 -0.158062 2.33881 0.398575L12.5 10.5063L22.6611 0.398575C23.2209 -0.158062 24.0998 -0.127999 24.6245 0.465774C25.1489 1.05955 25.1206 1.99215 24.5611 2.54879L13.4499 13.6014C12.9157 14.1329 12.0844 14.1329 11.5501 13.6014L0.438977 2.54879C-0.120635 1.99215 -0.148968 1.05955 0.375644 0.465774Z" fill="#AC8AF4" />
          </svg>
        </button>
